  ...
  factory ApiException.fromDio(DioException error) {
    ...
    if (status == 409) {
      ...
      const conflictMessages = <String, String>{
        ...
        'PARCEL_VALVES_INSPECTION_LOCKED':
            'La inspección remota está bloqueada. La captura local y su payload se conservarán para resolver el conflicto.',
        'PARCEL_VALVES_VERSION_INCOMPATIBLE':
            'La revisión remota cambió. Conservamos la captura para reconciliar versiones.',
        'PARCEL_VALVES_CATALOG_PENDING':
            'El catálogo de válvulas aún no está disponible. Se reintentará sin descartar la captura.',
        'PARCEL_VALVES_DATA_CONFLICT':
            'Las válvulas difieren de la versión remota. Revisa el conflicto conservado.',
      };
